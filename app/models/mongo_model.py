...
class Schedule(BaseModel):
    days: tuple[Day | None | str, Day | None | str, Day | None | str, Day | None | str, Day | None | str, Day | None | str]  # 6 дней
